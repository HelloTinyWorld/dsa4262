...
MODEL_PKL = "full_xgb_model.pkl"

# Ensure files exist (only necessary if we will parse/train)
...
# --------------------------
# ONLY-PARSING/TRAINING BLOCK
# This whole block is skipped if MODEL_PKL exists.
# --------------------------
if not os.path.exists(MODEL_PKL):
    ...
    joblib.dump(full_model, MODEL_PKL)

else:
    print(f"Found {MODEL_PKL} — skipping parsing/merging/training and reusing the existing model.")
